...
class SignUpForm(UserCreationForm):
    ...
    #Leave Labels black because we have place holders, widgets allows textinput, attrs = attrabuites, allow to pass attridutes onto page
    #Bootstrap requires class control hence the "class": "form-control"
    first_name = forms.CharField(label = "", max_length= 100, widget=forms.TextInput(attrs={"class": "form-control", "placeholder":"First Name"}))
    #Add max length for security
